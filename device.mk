...
# Google Photos
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/google_photos/product/pixel_2016_exclusive.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/pixel_2016_exclusive.xml
...
# Vendor init
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/services/android.hardware.drm@1.3-service.widevine.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.drm@1.3-service.widevine.rc \
